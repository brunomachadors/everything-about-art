...
test("A Liberdade guiando o povo", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1830")).toHaveText("📅 Ano: 1830");
...
test("As Banhistas", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1898")).toHaveText("📅 Ano: 1898");
  await expect(page.getByText("🌍 País de Origem: França")).toHaveText(
    "🌍 País de Origem: França"
  );
  ...
  ).toHaveText("🏛️ Localização: Museu de Arte de Philadelphia");
  await expect(
...
test("As Meninas", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1656")).toHaveText("📅 Ano: 1656");
  ...
  ).toContainText("A pintura é uma arte de pensamento - Diego Velázquez");
  await expect(page.getByText("Esta obra é da autoria do pintor")).toHaveText(
...
test("Caminhante Sobre o Mar de Névoa", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1818")).toHaveText("📅 Ano: 1818");
...
test("Composição 8", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1923")).toHaveText("📅 Ano: 1923");
...
test("Composição com Vermelho, Azul e Amarelo", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1930")).toHaveText("📅 Ano: 1930");
...
test("Fernando Pessoa", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1915")).toHaveText("📅 Ano: 1915");
...
test("Mona Lisa", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1503")).toHaveText("📅 Ano: 1503");
...
test("Noite Estrelada", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1889")).toHaveText("📅 Ano: 1889");
  await expect(page.getByText("🌍 País de Origem: Holanda")).toHaveText(
    "🌍 País de Origem: Holanda"
  );
  await expect(page.getByText("🧩 Estilo: Pós-Impressionismo")).toHaveText(
  ...
  ).toHaveText("🏛️ Localização: Museu de Arte Moderna, Nova Iorque");
  await expect(
...
test("O Beijo", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1907")).toHaveText("📅 Ano: 1907");
...
test("O Casal Arnolfini", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1434")).toHaveText("📅 Ano: 1434");
  await expect(page.getByText("🌍 País de Origem: Holanda")).toHaveText(
    "🌍 País de Origem: Holanda"
  );
...
test("O Grito", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1893")).toHaveText("📅 Ano: 1893");
...
test("O Lavrador de Café", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1934")).toHaveText("📅 Ano: 1934");
  ...
  ).toHaveText("🏛️ Localização: Museu de Belas-Artes, Rio de Janeiro");
  await expect(page.getByText("💰 Primeira Venda: Desconhecido")).toHaveText(
    "💰 Primeira Venda: Desconhecido"
  );
  await expect(
...
test("O Mar", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1958")).toHaveText("📅 Ano: 1958");
  await expect(page.getByText("🌍 País de Origem: Portugal")).toHaveText(
    "🌍 País de Origem: Portugal"
  );
  ...
  ).toHaveText("🏛️ Localização: Avenida Infante Santo, Lisboa");
  await expect(page.getByText("💰 Primeira Venda: Nenhuma")).toHaveText(
    "💰 Primeira Venda: Nenhuma"
  );
  await expect(page.getByText("📈 Última Revenda: Nenhuma")).toHaveText(
...
test("O Sonho", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1910")).toHaveText("📅 Ano: 1910");
  await expect(page.getByText("🌍 País de Origem: França")).toHaveText(
    "🌍 País de Origem: França"
  );
...
test("O Suprematismo", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1913")).toHaveText("📅 Ano: 1913");
  await expect(page.getByText("🌍 País de Origem: Rússia")).toHaveText(
    "🌍 País de Origem: Rússia"
  );
...
test("Os Baloiços e A Árvore na Prisão", async ({ page }) => {
  ...
  ).toHaveText("🎨 Artista: Maria Helena Vieira da Silva");
  await expect(page.getByText("📅 Ano: 1931")).toHaveText("📅 Ano: 1931");
  await expect(page.getByText("🌍 País de Origem: Portugal")).toHaveText(
    "🌍 País de Origem: Portugal"
  );
  ...
  ).toHaveText("🏛️ Localização: Fundação Arpad Szenes-Vieira da Silva, Lisboa");
  await expect(page.getByText("💰 Primeira Venda: Desconhecido")).toHaveText(
    "💰 Primeira Venda: Desconhecido"
  );
  await expect(
  ...
  ).toContainText("A arte é uma forma de liberdade.");
...
test("Parto da Viola", async ({ page }) => {
  ...
  ).toHaveText("🎨 Artista: Amadeo de Souza-Cardoso");
  await expect(page.getByText("📅 Ano: 1916")).toHaveText("📅 Ano: 1916");
  await expect(page.getByText("🌍 País de Origem: Portugal")).toHaveText(
    "🌍 País de Origem: Portugal"
  );
  await expect(page.getByText("🧩 Estilo: Modernismo,")).toBeVisible();
  ...
  ).toHaveText("📈 Última Revenda: Último leilão conhecido: 2.400.000 euros");
...
test("Rapariga com brinco de pérola", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1665")).toHaveText("📅 Ano: 1665");
  await expect(page.getByText("🌍 País de Origem: Holanda")).toHaveText(
    "🌍 País de Origem: Holanda"
  );
  await expect(page.getByText("🧩 Estilo: Barroco")).toHaveText(
...
test("Tríptico Auto-retrato, Sonho e Família", async ({ page }) => {
  ...
  await expect(page.getByText("🏛️ Localização: Desconhecido")).toHaveText(
    "🏛️ Localização: Desconhecido"
  );
  await expect(
    page.getByText("💰 Primeira Venda: Sem registros de venda pública.")
  ).toHaveText("💰 Primeira Venda: Sem registros de venda pública.");
  await expect(
    page.getByText("📈 Última Revenda: Sem registros de revenda conhecidos.")
  ).toHaveText("📈 Última Revenda: Sem registros de revenda conhecidos.");
...
test("Um Bar no Folies-Bergère", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1882")).toHaveText("📅 Ano: 1882");
  await expect(page.getByText("🌍 País de Origem: França")).toHaveText(
    "🌍 País de Origem: França"
  );
  await expect(page.getByText("🧩 Estilo: Impressionismo")).toHaveText(
...
test("Uma Tarde de Domingo na Ilha de Grande Jatte", async ({ page }) => {
  ...
  await expect(page.getByText("📅 Ano: 1884")).toHaveText("📅 Ano: 1884");
  await expect(page.getByText("🌍 País de Origem: França")).toHaveText(
    "🌍 País de Origem: França"
  );
  await expect(page.getByText("🧩 Estilo: Pós-Impressionismo")).toHaveText(
...
test("Zé Povinho", async ({ page }) => {
  ...
  ).toHaveText("🎨 Artista: Rafael Bordalo Pinheiro");
  await expect(page.getByText("📅 Ano: 1875")).toHaveText("📅 Ano: 1875");
  await expect(page.getByText("🌍 País de Origem: Portugal")).toHaveText(
    "🌍 País de Origem: Portugal"
  );
